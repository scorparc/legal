...
FEATURES = {
    ...
    "scootkeeper": {
        "de": [
            ("Optionales Google-Drive-Backup (Pro-Funktion)", "Wenn du die Backup-Funktion aktiv nutzt, werden deine App-Daten einschließlich Fotos als Sicherungsdatei in den versteckten, app-eigenen Bereich (\"appDataFolder\") deines Google-Drive-Kontos hochgeladen. Die Übertragung erfolgt verschlüsselt (TLS). Wir erhalten keinen Zugriff auf die Sicherung. Google Ireland Limited verarbeitet Kontodaten als eigenständiger Verantwortlicher. Du kannst das Backup beenden und dich abmelden."),
            ...
            ("Käufe über Google Play", "Kostenpflichtige Pro-Funktionen werden über Google Play Billing abgewickelt. Google verarbeitet Zahlungs- und Kontodaten; wir erhalten nur den Kauf- beziehungsweise Abostatus."),
        ...
        "en": [
            ...
            ("Purchases via Google Play", "Paid Pro features are processed through Google Play Billing. Google processes payment and account data; we receive only the purchase or subscription status."),
        ...
        "es": [
            ("Copia opcional en Google Drive (función Pro)", "Si utilizas activamente la copia, los datos de la aplicación, incluidas las fotos, se cargan como archivo en el área oculta appDataFolder de tu cuenta de Google Drive. La transferencia está cifrada (TLS). No tenemos acceso a la copia. Google Ireland Limited trata los datos de la cuenta como responsable independiente. Puedes detener la copia y cerrar sesión."),
            ...
            ("Compras mediante Google Play", "Las funciones Pro de pago se procesan mediante Google Play Billing. Google trata los datos de pago y de la cuenta; solo recibimos el estado de compra o suscripción."),
        ...
        "fr": [
            ...
            ("Achats via Google Play", "Les fonctions Pro payantes sont traitées via Google Play Billing. Google traite les données de paiement et du compte ; nous recevons uniquement le statut d'achat ou d'abonnement."),
        ...
        "it": [
            ("Backup Google Drive facoltativo (funzione Pro)", "Se utilizzi attivamente il backup, i dati dell'app, comprese le foto, vengono caricati nell'area nascosta appDataFolder del tuo account Google Drive. Il trasferimento è crittografato (TLS). Non abbiamo accesso al backup. Google Ireland Limited tratta i dati dell'account come titolare autonomo. Puoi interrompere il backup e disconnetterti."),
            ...
            ("Acquisti tramite Google Play", "Le funzioni Pro a pagamento sono gestite tramite Google Play Billing. Google tratta i dati di pagamento e dell'account; riceviamo solo lo stato dell'acquisto o dell'abbonamento."),
        ...
        "pt": [
            ("Cópia opcional no Google Drive (função Pro)", "Se utilizares ativamente a cópia, os dados da aplicação, incluindo fotografias, são carregados para a área oculta appDataFolder da tua conta Google Drive. A transferência é cifrada (TLS). Não temos acesso à cópia. A Google Ireland Limited trata os dados da conta como responsável independente. Podes parar a cópia e terminar sessão."),
            ...
            ("Compras através do Google Play", "As funções Pro pagas são processadas através do Google Play Billing. A Google trata os dados de pagamento e da conta; recebemos apenas o estado da compra ou da subscrição."),
